# Generates sample utterances for WordBox based on 1,000 of the most common words in the English language
...
with open(os.path.dirname(os.path.realpath(__file__)) + "/" + output_file, "w") as f:
